...
func (ai *EnemyNetAI) DidLoseHero(hero *herolib.Hero) {
...
func (ai *EnemyNetAI) DidExplore(x int, y int, plane data.Plane) {
    ai.stats.territoryExplored += 1
}
...
func (ai *EnemyNetAI) DidDiscoverEnemy(other *playerlib.Player) {
    ai.stats.enemiesDiscovered += 1
}
