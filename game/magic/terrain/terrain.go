...
var (
    ...
    TileRiver1100_3     = makeRiverTile(0xE9, expand4(0b1100))
    TileRiver0011_3     = makeRiverTile(0xEA, expand4(0b0011))
    TileRiver0110_3     = makeRiverTile(0xEB, expand4(0b0110))
    TileRiver1001_3     = makeRiverTile(0xEC, expand4(0b1001))
    TileRiver1010_1     = makeRiverTile(0xED, expand4(0b1010))
    TileRiver1010_2     = makeRiverTile(0xEE, expand4(0b1010))
    TileRiver1010_3     = makeRiverTile(0xEF, expand4(0b1010))
    TileRiver0101_1     = makeRiverTile(0xF0, expand4(0b0101))
    TileRiver0101_2     = makeRiverTile(0xF1, expand4(0b0101))
    TileRiver0101_3     = makeRiverTile(0xF2, expand4(0b0101))
    TileRiver1101_1     = makeRiverTile(0xF3, expand4(0b1101))
    TileRiver1101_2     = makeRiverTile(0xF4, expand4(0b1101))
    TileRiver1101_3     = makeRiverTile(0xF5, expand4(0b1101))
    TileRiver1101_4     = makeRiverTile(0xF6, expand4(0b1101))
    TileRiver0111_1     = makeRiverTile(0xF7, expand4(0b0111))
    TileRiver0111_2     = makeRiverTile(0xF8, expand4(0b0111))
    TileRiver0111_3     = makeRiverTile(0xF9, expand4(0b0111))
    TileRiver0111_4     = makeRiverTile(0xFA, expand4(0b0111))
    TileRiver1110_1     = makeRiverTile(0xFB, expand4(0b1110))
    TileRiver1110_2     = makeRiverTile(0xFC, expand4(0b1110))
    TileRiver1110_3     = makeRiverTile(0xFD, expand4(0b1110))
    TileRiver1110_4     = makeRiverTile(0xFE, expand4(0b1110))
    TileRiver1011_1     = makeRiverTile(0xFF, expand4(0b1011))
    TileRiver1011_2     = makeRiverTile(0x100, expand4(0b1011))
    TileRiver1011_3     = makeRiverTile(0x101, expand4(0b1011))
    TileRiver1011_4     = makeRiverTile(0x102, expand4(0b1011))
    ...
    TileDesert_00000000  = makeDesertTile(0x134, 0b00000000)
    ...
    TileTundra           = makeTundraTile(0x26A, AllDirections)
