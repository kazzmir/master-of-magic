...
type Unit struct {
    ...
    RangedMagicalRealm data.MagicType
...
var LizardShamans Unit = Unit{
    ...
    RangedMagicalRealm: data.NatureMagic,
    ProductionCost: 60,
...
var OrcMagicians Unit = Unit{
    ...
    RangedAttacks: 4,
    RangedAttackDamageType: DamageRangedMagical,
    RangedMagicalRealm: data.ChaosMagic,
    Defense: 3,
    Resistance: 8,
    HitPoints: 1,
...
var HeroZaldron Unit = Unit{
    ...
    RangedMagicalRealm: data.SorceryMagic,
    Defense: 4,
    Resistance: 6,
    HitPoints: 5,
    Abilities: []data.Ability{
