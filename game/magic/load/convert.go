...
func (saveGame *SaveGame) Convert(cache *lbx.LbxCache, music *musiclib.Music, settings *settingslib.Settings) *gamelib.Game {
    game := gamelib.MakeGame(cache, music, settings, saveGame.convertSettings())
