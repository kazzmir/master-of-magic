...
func createScenario2(cache *lbx.LbxCache) *gamelib.Game {
    ...
    introCity := citylib.MakeCity("Test City", 4, 5, data.RaceHighElf, player.Wizard.Banner, player.TaxRate, game.BuildingInfo, player)
...
func createScenario3(cache *lbx.LbxCache) *gamelib.Game {
    ...
    introCity := citylib.MakeCity("Test City", x, y, player.Wizard.Race, player.Wizard.Banner, player.TaxRate, game.BuildingInfo, player)
    introCity.Population = 6000
    introCity.Plane = data.PlaneArcanus
    introCity.ProducingBuilding = buildinglib.BuildingHousing
    introCity.ProducingUnit = units.UnitNone
...
func createScenario4(cache *lbx.LbxCache) *gamelib.Game {
    ...
    introCity := citylib.MakeCity("Test City", x, y, data.RaceHighElf, player.Wizard.Banner, player.TaxRate, game.BuildingInfo, player)
    introCity.Population = 6000
    introCity.Plane = data.PlaneArcanus
    introCity.ProducingBuilding = buildinglib.BuildingHousing
    introCity.ProducingUnit = units.UnitNone
...
func createScenario6(cache *lbx.LbxCache) *gamelib.Game {
    ...
    city2 := citylib.MakeCity("utah", x, y, data.RaceDarkElf, player.Wizard.Banner, player.TaxRate, game.BuildingInfo, player)
...
func createScenario7(cache *lbx.LbxCache) *gamelib.Game {
    ...
    for i := 0; i < 15; i++ {
        ...
        introCity := citylib.MakeCity(fmt.Sprintf("city%v", i), x, y, data.RaceHighElf, player.Wizard.Banner, player.TaxRate, game.BuildingInfo, player)
...
func createScenario8(cache *lbx.LbxCache) *gamelib.Game {
    ...
    city := citylib.MakeCity("Test City", x, y, data.RaceHighElf, player.Wizard.Banner, player.TaxRate, game.BuildingInfo, player)
...
func createScenario20(cache *lbx.LbxCache) *gamelib.Game {
    ...
    city2 := citylib.MakeCity("Test City", x, y-1, enemy.Wizard.Race, enemy.Wizard.Banner, fraction.Zero(), game.BuildingInfo, enemy)
    city2.Population = 5000
    city2.Plane = data.PlaneArcanus
