...
func createScenario37(cache *lbx.LbxCache) *gamelib.Game {
    ...
    unit1 := player1.AddUnit(units.MakeOverworldUnitFromUnit(units.MagicSpirit, x + 1, y + 1, data.PlaneArcanus, wizard1.Banner, nil))
    ...
    node := nodes[terrain.NatureNode][0]
    player1.LiftFog(node.X, node.Y, 3, data.PlaneArcanus)
    player1.AddUnit(units.MakeOverworldUnitFromUnit(units.MagicSpirit, node.X + 1, node.Y + 1, data.PlaneArcanus, wizard1.Banner, nil))
