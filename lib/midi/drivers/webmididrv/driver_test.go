//go:build js && wasm && !windows && !linux && !darwin && midi
// +build js,wasm,!windows,!linux,!darwin,midi
...
import (
	...
	"github.com/kazzmir/master-of-magic/lib/midi/drivers/internal/drivertest"
)
